...
// EventRecorderAdapter is a wrapper around a "github.com/spotmaxtech/k8s-client-go-v02217/tools/record".EventRecorder
// implementing the new "github.com/spotmaxtech/k8s-client-go-v02217/tools/events".EventRecorder interface.
type EventRecorderAdapter struct {
	recorder EventRecorder
}

// NewEventRecorderAdapter returns an adapter implementing the new
// "github.com/spotmaxtech/k8s-client-go-v02217/tools/events".EventRecorder interface.
