...
```go
import _ "github.com/spotmaxtech/k8s-client-go-v02217/plugin/pkg/client/auth"
```

Or you can load specific auth plugins:
```go
import _ "github.com/spotmaxtech/k8s-client-go-v02217/plugin/pkg/client/auth/azure"
import _ "github.com/spotmaxtech/k8s-client-go-v02217/plugin/pkg/client/auth/gcp"
import _ "github.com/spotmaxtech/k8s-client-go-v02217/plugin/pkg/client/auth/oidc"
import _ "github.com/spotmaxtech/k8s-client-go-v02217/plugin/pkg/client/auth/openstack"
```
